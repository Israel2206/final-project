...
public class LutaCinco {
    ...
    public void iniciarLutaCinco() {
        paineis.painelLutaCinco();
        ...
        do {
            ...
            if (monstroInimigo.getVida() <= 0) {
                ...
                System.out.println("A Vida do seu " + monstroJogador.getNome() + " foi restaurada!");
            ...
            if (monstroJogador.getVida() <= 0) {
                paineis.pausa(700);
                System.out.println("\nSeu monstro caiu na arena...");
                paineis.pausa(900);

                System.out.println("O vento corta, empurra e não dá espaço para erro.");
                paineis.pausa(900);
                System.out.println("Você foi superado.");
                paineis.pausa(1200);
    ...
    private void turnoInimigo() {
        paineis.pausa(600);
        System.out.println("\nO " + monstroInimigo.getNome() + " se move como o vento!");
        paineis.pausa(700);
